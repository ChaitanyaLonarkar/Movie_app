...
export const API_KEY = "323e3fe5a8237f5319c4b400fb4bd2d9";
...
export const TV_SHOWS= `https://api.themoviedb.org/3/tv/on_the_air?api_key=${API_KEY}&language=en-US&page=1`;
